...
G.map({
    ...
    { 'i', '<c-h>',     '(".") == col("$") ? \'<esc>"_db"_xa\' : \'<esc>"_db"_xi\'', { noremap = true, expr = true } },
    ...
    { 'v', '<s-left>',  'b',                                                         { noremap = true } },
    { 'i', '<s-right>', '<esc>ea',                                                   { noremap = true } },
    { 'i', '<s-left>',  '<esc>bi',                                                   { noremap = true } },
    ...
    { 'i', '<c-s-down>', '<down><down><down><down><down><down><down><down><down><down>',
        {
            noremap = true,
            silent = true
        } },
    ...
    -- { 'i', '<c-J>',       '<up><up><up><up><up><up><up><up><up><up>', { noremap = true, silent = true } },
    -- { 'i', '<c-K>', '<down><down><down><down><down><down><down><down><down><down>',
    --     {
    --         noremap = true,
    --         silent = true
    --     } },
    -- { 'i', '<c-H>',     '<home>',                                                    { noremap = true, silent = true } },
    -- { 'i', '<c-L>',     '<end>',                                                     { noremap = true, silent = true } },
    -- { 'n', '<c-K>',     '10k',                                                       { noremap = true } },
    -- { 'n', '<c-J>',     '10j',                                                       { noremap = true } },
    -- { 'n', '<c-H>',     '^',                                                         { noremap = true } },
    -- { 'n', '<c-L>',     '$',                                                         { noremap = true } },
    -- { 'v', '<c-K>',     '10k',                                                       { noremap = true } },
    -- { 'v', '<c-J>',     '10j',                                                       { noremap = true } },
    -- { 'v', '<c-H>',     '^',                                                         { noremap = true } },
    -- { 'v', '<c-L>',     '$h',                                                        { noremap = true } },
    ...
    { 'n', '<m-tab>',     ':bn<cr>',                                                   { noremap = true, silent = true } },
